...
class Graph:
  ...
  def explore(self):
    ...
    while 'treasure_room' not in current_room:
      node = self.graph_dict[current_room]
      # Iterate through items of the nodes edges and retrieves each connected_room and weight
      ...
      print("\nYou have accumultad: {0} cost".format(path_total))
